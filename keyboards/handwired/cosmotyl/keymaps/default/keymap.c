...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DVORAK] = LAYOUT(
        ...
        KC_TAB,   KC_QUOT,  KC_COMM,  KC_DOT,   KC_P,     KC_Y,     KC_BTN2,    KC_BTN3,  KC_F,     KC_G,     KC_C,     KC_R,     KC_L,     KC_SLASH,
        KC_ESC,   KC_A,     KC_O,     KC_E,     KC_U,     KC_I,     KC_BTN1,    KC_DEL,   KC_D,     KC_H,     KC_T,     KC_N,     KC_S,     KC_MINS,
        KC_LSFT,  KC_SCLN,  KC_Q,     KC_J,     KC_K,     KC_X,                           KC_B,     KC_M,     KC_W,     KC_V,     KC_Z,     KC_RSFT,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_LALT,                                                                KC_RALT,  XXXXXXX,  XXXXXXX,  KC_RCTL,
                                      KC_LCTL,  KC_SPC,   KC_LALT,                                            RAISE,
                                                XXXXXXX,  XXXXXXX,                        KC_BTN1,  KC_LGUI,  KC_BSPC
    ),
